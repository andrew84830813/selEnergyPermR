...
This step is optional as any level can be tested (i.e. Phylum,Class, Order, etc..) as well as the overall OTU composition
...
Here we use Monte-Carlo sampling from the permutation distribution to test significance of the sparse association. We recommend at least 150 permutations.
